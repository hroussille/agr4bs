...
def test_agent_retrieval():
    ...
    agent1 = agr4bs.ExternalAgent("agent1", genesis, agr4bs.IFactory)
    agent2 = agr4bs.ExternalAgent("agent2", genesis, agr4bs.IFactory)
    agent3 = agr4bs.ExternalAgent("agent3", genesis, agr4bs.IFactory)
