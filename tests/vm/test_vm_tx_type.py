import agr4bs
from agr4bs.vm.default_vm import TransactionType
...
def test_tx_type_transfer():
    ...
    tx = agr4bs.Transaction(origin="account_0", nonce=0,
    ...
    assert agr4bs.VM._get_transaction_type(
...
def test_tx_type_noop():
    ...
    """
    state = agr4bs.State()
    tx = agr4bs.Transaction(origin="account_0", nonce=0, to="account_1")
