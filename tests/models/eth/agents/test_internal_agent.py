...
def test_internal_agent_default_constructor():
    ...
    context = ExecutionContext(
        "origin", "from", "internal_agent_0", 0, 0, state, agr4bs.models.eth.VM)
...
def test_internal_agent_entry_point_valid_multi_parameters():
    ...
    context = ExecutionContext("origin", "from", "internal_agent_0", 0, 0, state, agr4bs.models.eth.VM)
    response = internal_agent.entry_point(calldata, context)
...
def test_internal_agent_entry_point_invalid_function():
    ...
    state = agr4bs.State()
    context = ExecutionContext("origin", "from", "to", 0, 0, state, agr4bs.models.eth.VM())
    response = internal_agent.entry_point(calldata, context)
