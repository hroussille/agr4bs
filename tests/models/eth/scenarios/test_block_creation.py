...
def test_block_creation():
    ...
    agr4bs.models.eth.Factory.build_network(reset=True)
    genesis = agr4bs.models.eth.blockchain.Block(None, "genesis", [])

    agents = []

    for i in range(20):
        agent = agr4bs.ExternalAgent(
            f"agent_{i}", genesis, agr4bs.models.eth.Factory)
    ...
    scheduler = agr4bs.Scheduler(
        env, agr4bs.models.eth.Factory, current_time=epoch)
